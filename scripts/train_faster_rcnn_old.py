...
#                        help="Base network name which serves as feature extraction base.")
    ...
    parser.add_argument('--save-prefix', type=str, default='checkpoints_frcnn/',
    ...
    #args.dataset == 'custom':
    args.epochs = int(args.epochs) if args.epochs else 30
    args.lr_decay_epoch = args.lr_decay_epoch if args.lr_decay_epoch else '10,20'
